...
HD_PWD='C:/Users/Nixon/Desktop/projects/neural_networks/light_neural_network/neuron_unit/vivado_project/vivado_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neuron_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neuron_unit.tcl
