...
HD_PWD='C:/Users/Nixon/Desktop/projects/neural_networks/light_neural_network/memory_stage/vivado_project/vivado_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_stage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memory_stage.tcl
